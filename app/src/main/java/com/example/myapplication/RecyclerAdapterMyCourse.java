...
public class RecyclerAdapterMyCourse extends RecyclerView.Adapter<RecyclerAdapterMyCourse.ViewHolder> {
    ArrayList<CourseModel>courseModelArrayList;
    Context context;
    CardView cardView;
    RecyclerAdapterMyCourse(Context context,ArrayList<CourseModel>courseModelArrayList){
